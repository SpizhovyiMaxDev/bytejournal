    ...
    <div class="container form_section-container">
        ...
        <form action="<?= ROOT_URL ?>signup_logic.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form_control">
                <label for="avatar">User Avatar (Optional)</label>
                <input type="file" name="avatar" id="avatar" accept=".png,.jpg,.jpeg">
                <small style="color: var(--color-gray-300); font-size: 0.8rem;">If no image is uploaded, a default avatar will be used.</small>
            </div>
